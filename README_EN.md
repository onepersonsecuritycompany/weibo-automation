...
> **微博自动化技能** - Automate Weibo operations with natural language
...
| Action | English Triggers | 中文触发词 |
|--------|------------------|-----------|
| Post Weibo | post to Weibo, publish a Weibo | 发微博、发布一条微博 |
| Get Hot Search | hot search, trending topics | 热搜、微博热搜 |
| Analyze Trends | analyze hot search, analyze trends | 分析热搜、热搜趋势 |
